---
title: "Importing our gene data into R"
output:
  html_document:
    code_folding: hide
    collapsed: no
...
Change to color and access labels - to close together
...
The advantages of using ggplot as opposed to plotting in base R are putting it all in color and putting the specific names plu tissue used for that gene. The disadvantages of using ggplot as opposed to plotting in base R is it being easier to code then ggplot. 
